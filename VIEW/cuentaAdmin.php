...
<head>
    ...
    <meta name="description" content="Cuenta del administrador de la gestora catalana Event Hunters">
    ...
    <title>Cuenta Adminitrador - Event Hunters</title>
            ...
            <div id="contTitle">
                ...
                <div id="contInputs2">
                    ...
                    <span id="imgProfile">
                        <?php
                            if ($foto) {
                                echo '<img src="../CONTROLLER/' . $foto . '" alt="Foto de perfil">';
                            } else {
                                echo '<img src="../IMG/favicon.svg" alt="Foto por defecto">';
                            }
                        ?>
                    </span>
